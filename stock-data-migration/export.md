...
FROM CGM_DDB.stock_center sc;
```
**Problem**: There are annotations for a maximum of 4,523 strains, which means that 1,540 do not have annotations. The number of the files do not make sense right now, so it requires a deep analysis.
---
...
With SQL
   ...
   19297 strain_characteristics.tsv
    ...
    5988 strain_publications.tsv
    1949 strain_publications_no_pubmed.tsv
